...
from Shikimori import DRAGONS, JOIN_LOGGER, LOGGER, SUPPORT_CHAT, dispatcher
from Shikimori.modules.disable import DisableAbleCommandHandler
from Shikimori.modules.helper_funcs.chat_status import connection_status, user_admin
...
from Shikimori.modules.helper_funcs.string_handling import escape_invalid_curly_brackets
...
`buttonurl:` section, as such: `[somelink](buttonurl:example.com)`. Check `/markdownhelp` for more info.
 ...
 𝗡𝗼𝘁𝗲 Note names are case-insensitive, and they are automatically converted to lowercase before getting saved.
